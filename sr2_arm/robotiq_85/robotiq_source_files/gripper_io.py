# Copyright (C) 2015 Stanley Innovation Inc.
#
...
__author__ = "Stanley Innovation Inc"
__copyright__ = "Copyright (C) 2015 Stanley Innovation Inc."
...
class GripperIO:
    ...
    def _update_action_req(self):
        self._act_req = self.rACT | (self.rGTO << 3) | (
            self.rATR << 4) | (self.rARD << 5)
